Shader "Roystan/Toon/GeometryGrass_URP" {
    Properties{
        ...
        SubShader{
            ...
            // Multi-compiles pour les ombres et les lumi̬res
            ...
            void gp(point v2g points[1], inout TriangleStream<g2f> triStream) {
                ...
                // On utilise la position du brin dans le monde pour g̩n̩rer des taches de couleur douces
                float3 worldRootPos = TransformObjectToWorld(root.xyz);
                float colorNoise = snoise(worldRootPos * _ColorNoiseScale) * 0.5 + 0.5;
                // On m̩lange le bruit (70%) avec le random individuel (30%) pour plus de naturel
